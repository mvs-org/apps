...
function createExternals (t: TFunction): ItemRoute[] {
  return [
    { href: 'https://github.com/mvs-org', icon: 'code-branch', name: 'github', text: t<string>('nav.github', 'GitHub', { ns: 'apps-routing' }) },
    { href: 'https://learn.mvs.org', icon: 'book', name: 'wiki', text: t<string>('nav.wiki', 'Learn', { ns: 'apps-routing' }) }
  ];
}
