...
# @mvs-org/metaverse-vm-apps

A Portal into the Metaverse Virtual Machine. Provides a view and interaction layer from a browser.

This can be accessed as a hosted application via https://vm.mvs.org/apps/.
